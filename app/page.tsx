...
const linkData: LinkData[] = [
  ...
  { title: "X / Twitter", href: "https://twitter.com/_andys8" },
...
function LinkButton({ title, href }: LinkData) {
  return (
    <a className="p-[3px] relative" href={href} target="_blank" rel="noopener">
...
export default function Home() {
  return (
    <div className="w-full bg-black flex flex-col items-center justify-center overflow-hidden absolute inset-0">
      <h1 className="md:text-7xl text-3xl font-bold text-center text-white relative z-20 select-none">
        andys8
      </h1>
      ...
      <div className="grid grid-cols-1 gap-4 mt-[-6rem]">
        {linkData.map((link, i) => (
